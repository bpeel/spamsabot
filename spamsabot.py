...
URL\s+это\s+моя\s+ссылочка,\s+заходите\s+ко\s+мне,\s+хочу\s+познакомится\)+

|

скучаешь\?\s+заходи\s+ко\s+мне\s+сюда\s+URL\s+регистрируйся\s+
бесплатно\s+и\s+найди\s+себе\s+девушку\)+

|

как\s+я\s+вам\?\s+зайди\s+сюда\s+URL\s+\s+жду\s+вас\)+

|

[\w\u0430-\u044f]+\s+\d+,\s+ищу\s+себе\s+парня,\s+заходи\s+сюда\s+
URL\s+и\s+регистрируйся
...
Меня\s+зовут\s+[\w\u0430-\u044f]+,\s+мне\s+\d+,\s+ищу\s+парня\)*\s+моя\s+
ссылка\s+URL\s+\s+\s+Зайди\s+и\s+найди\s+себе\s+девушку\)*

|

[\w\u0430-\u044f]+,\s+26,\s+заходи\s+на\s+сайт\s+знакомств\s+по\s+моей\s+
ссылке\s+URL\s+и\s+найди\s+себе\s+пару\s+на\s+вечер\s+или\s+на\s+всю\s+жизнь

|

Ищу\s+парня,\s+моя\s+ссылочка\s+URL\s+\s+жду\s+вас\)*

|

Cкучаю,\s+заходи\s+ко\s+мне\s+сюда\s+URL\s+\s+смотри\s+мои\s+приват\s+фото\s+
и\s+видео\s+бесплатно\s+по\s+моей\s+ссылке\)*\s+URL

|

URL\s+\s+\s+\s+Яночка\s+26

|

Заходи\s+и\s+знакомся\s+с\s+девушками\s+и\s+участвуй\s+в\s+приват\s+чате\s+URL

|

Зарегистрируйся\s+пожалуйста\s+по\s+моей\s+ссылке\s+URL\s+\s+знакомся\s+с\s+
девушками\s+и\s+смотри\s+фото\s+и\s+видео\)*
...
assert(FILTER_RE.match(r"Кто хочет пошалить со мной? https://is.gd/Y6vdsE  "
                       r"это моя ссылочка"))
assert(FILTER_RE.match(r"https://is.gd/Y6vdsE это моя ссылочка, заходите ко "
                       r"мне, хочу познакомится)))"))
assert(FILTER_RE.match(r"скучаешь? заходи ко мне сюда https://is.gd/Y6vdsE "
                       r"регистрируйся бесплатно и найди себе девушку)))"))
assert(FILTER_RE.match(r"как я вам? зайди сюда https://is.gd/Y6vdsE  жду "
                       r"вас))"))
assert(FILTER_RE.match(r"Яна 31, ищу себе парня, заходи сюда "
                       r"https://is.gd/Y6vdsE и регистрируйся"))
assert(FILTER_RE.match(r"Настоящие девушки и живое общение только сдесь "
                       r"https://is.gd/Y6vdsE  заходи не бойся это "
                       r"бесплатно)))"))
assert(FILTER_RE.match(r"Меня зовут Оля, мне 28, ищу парня)) моя ссылка "
                       r"https://is.gd/YsE9St   Зайди и найди себе девушку))"))
assert(FILTER_RE.match(r"Яночка, 26, заходи на сайт знакомств по моей ссылке "
                       r"https://is.gd/YsE9St и найди себе пару на вечер или "
                       r"на всю жизнь"))
assert(FILTER_RE.match(r"Ищу парня, моя ссылочка https://is.gd/YsE9St  "
                       r"жду вас)))"))
assert(FILTER_RE.match(r"Cкучаю, заходи ко мне сюда https://is.gd/YsE9St  "
                       r"смотри мои приват фото и видео бесплатно по моей "
                       r"ссылке))) https://is.gd/YsE9St"))
assert(FILTER_RE.match(r"https://is.gd/YsE9St    Яночка 26"))
assert(FILTER_RE.match(r"Заходи и знакомся с девушками и участвуй в приват "
                       r"чате https://is.gd/YsE9St"))
assert(FILTER_RE.match(r"Зарегистрируйся пожалуйста по моей ссылке "
                       r"https://is.gd/YsE9St  знакомся с девушками и смотри "
                       r"фото и видео)))"))
